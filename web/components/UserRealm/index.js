    ...
    return (
      <div className="userRealm-root">
        ...
        <div>
          ...
          <div className="userRealm-creation-wrapper global-modal-wrapper">
        ...
        <div>
          ...
          <div className="userRealm-creation-wrapper global-modal-wrapper">
            <div className="userRealm-creation-box global-modal-box">
              ...
              <form onSubmit={(e) => {
                e.preventDefault();
                const data = { user: extractDataForm(e.target, ['github_token', 'passphrase', 'git_commit_email']) };
                createUser(data);
              }}>
                <div className="input-box">
                  <label htmlFor="user_passphrase">Password</label>
                  <input required autoComplete="off" type="password" minLength="16" id="user_passphrase" name="passphrase" />
                </div>
                <div className="input-box">
